...
<section id="box">
	...
	<span>{{search}}</span> <!-- v-model과 같은 이름일 경우 입력한 값 출력 -->
	<br><br>
...
<form id="f" method="get" action="./vue4.jsp"> <!-- form은 vue와 상관없이 사용 가능 -->
	<section id="box2">
		<!-- checkbox, radio는 value가 적용되어 get, post로 값을 전송할 수 있음 -->
		<input type="checkbox" name="ag" value="Y" v-model="agree">동의함
